...
namespace MyComputerManager
{
    ...
    public partial class MainWindow : INavigationWindow
    {
        ...
        private ViewModels.MainPageViewModel GetMainPageVM()
        {
            var currentPage = RootFrame.Content as Views.MainPage;
            return currentPage?.DataContext as ViewModels.MainPageViewModel;
        }
