...
namespace MyComputerManager.Models
{
    public class NamespaceItem : INotifyPropertyChanged
    {
        ...
        public string RegKey_CLSID
        {
            get
            {
                string subPath = RegKey1.View == RegistryView.Registry64 ? @"\SOFTWARE\Classes\CLSID\"
                    : (RegKey1.View == RegistryView.Default ? @"\SOFTWARE\Classes\CLSID\" : @"\SOFTWARE\Classes\WOW6432Node\CLSID\");
                return RegKey1.Name + subPath + CLSID;
            }
        }
